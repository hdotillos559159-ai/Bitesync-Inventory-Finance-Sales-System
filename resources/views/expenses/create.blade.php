...
@section('title', 'BiteSync | Add Expense')
...
<style>
    ...
    .expense-create-page .page-title small {
        display: block;
        margin-bottom: 5px;
        color: #a9825b;
        font-size: 10px;
    ...
    .expense-create-page .page-title h1 {
        margin: 0;
        color: var(--dark);
        font-size: 29px;
        font-weight: 700;
    ...
    .expense-create-page .page-title p {
        margin: 6px 0 0;
        color: var(--muted);
        font-size: 12px;
        line-height: 1.5;
...
<div class="expense-create-page">
    ...
    <div class="topbar">
        ...
        <div class="page-title">
            ...
            <p>
                Record a new operating expense for your BiteSync business.
            </p>
    ...
    >
                    ...
                    <div class="basic-fields-grid">
                        ...
                        <div class="form-group">
                            ...
                            >
                                ...
                                <option
                                    value="Recorded"
                                    @selected(old('status', 'Recorded') === 'Recorded')
                                >
                                    Recorded
                                </option>
            ...
            <div class="form-panel">
                ...
                <div class="form-panel-header">
                    ...
                    <div>
                        ...
                        <div class="form-panel-subtitle">
                            Enter the amount and supporting details.
                        </div>
        ...
        <div class="form-panel additional-panel">
            ...
            <div class="form-panel-header">
                ...
                <div>
                    ...
                    <div class="form-panel-subtitle">
                        Expense ownership and record information.
                    </div>
                ...
                <div class="recording-card">
                    ...
                    <div class="recording-text">
                        ...
                        <div class="recording-title">
                            Recorded by the current BiteSync user
                        </div>

                        <div class="recording-description">
                            The system automatically connects this expense to the currently authenticated user. No manual user selection is required.
                        </div>
        ...
        <div class="information-box">
            ...
            <div class="information-box-content">
                ...
                Check the category, amount, expense date, and status before recording the expense. Cancelled expenses will not be included in the Expense totals.
